...
<head>
  ...
  <title>Admiinistrator | Dashboard</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
         ...
         <li>
          <a href="http://localhost/mschool/admin/login">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 Kelompok Prgoram Pengabdian Masyarakat</strong> All rights reserved.
  </footer>
