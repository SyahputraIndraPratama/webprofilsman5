...
<head>
    ...
    <title>SMA Negeri 5 Tegal</title>
    <link rel="shorcut icon" href="<?php echo base_url().'theme/images/tut-wuri-handayani-7759.png'?>">
    <!-- Bootstrap CSS -->
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>(0283) 355285
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>sman5kotategal@gmail.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Tegal, Jawa Tengah
                        </div>
                    </div>
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/sma 5 tegal.png'?>" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/tegal.png'?>" alt="Second slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Guru Yang Bekualitas</h1>
                            <h4>Guru merupakan faktor penting dalam proses belajar-mengajar.</h4>
                            <div class="slider-btn">
                ...
                <div class="carousel-item">
                    <img class="d-block" src="<?php echo base_url().'theme/images/tegal-2.png'?>" alt="Third slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
            ...
            <div class="col-md-3">
                <div class="foot-logo">
                    <a href="<?php echo site_url();?>">
                        <img width="150"  src="<?php echo base_url().'theme/images/tut-wuri-handayani-7759.png'?>" class="img-fluid" alt="footer_logo">
                    </a>
                    <p><?php echo date('Y');?> © copyright by Kelompok Program Pengabdian Masyarakat</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Jl. Kali Kemiri II, Margadana, Kec. Margadana, Kota Tegal, Jawa Tengah 52143</p>
                        <p>Email : sman5kotategal@gmail.com
                            <br> Phone : (0283) 355285</p>
